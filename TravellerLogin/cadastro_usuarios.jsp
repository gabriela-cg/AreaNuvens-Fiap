...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container my-5">
            ...
            <p class="p-3 text-light cor__fundo">Cadastrar Novo Usuário</p>
            <form method="post" id="dados-conta" action="">
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn my-3" id="gravar" >Gravar Alterações </button>
                </div>
            </form>
        </div>
        <footer class="p-4 text-light cor__fundo">
            <h5 class="text-center">Projeto Traveller - Direitos reservados para trabalho acadêmico FIAP</h5>
        </footer>
